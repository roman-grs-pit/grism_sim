...
def mk_ref_image(tel_ra,tel_dec,pa,det_num,star_input,gal_input,output_dir,psf_cutout_size=365,github_dir=os.getenv['github_dir'],gal_mag_col='mag_F158_Av1.6523',dogal='y'):
