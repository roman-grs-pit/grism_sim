...
parser.add_argument("--mockdir", help="directory for galacticus mocks; defaults to location on NERSC", default='/global/cfs/cdirs/m4943/grismsim/galacticus_4deg2_mock/')
