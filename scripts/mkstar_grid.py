...
parser.add_argument("--fast_direct", help="if y, a single PSF is used over the whole detector when making the direct image", default='n')
...
if args.mkdirect == 'y':
	...
	for i in range(0,len(stars00)):
		...
		if args.fast_direct == 'y':
		    ...
		    sp = iu.star_postage_grid(mag, detx=xp, dety=yp, fov_pixels=pad-1)
		fov_pixels = pad-1
